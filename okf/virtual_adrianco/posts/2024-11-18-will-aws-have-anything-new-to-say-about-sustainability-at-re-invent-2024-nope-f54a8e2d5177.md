...
[Update: Nothing new on carbon metrics, but AWS did a press release about their latest datacenter efficiency technology, which looks very good, and released Power Usage Effectiveness (PUE) data for all their regions for 2022 and 2023, which is a welcome development. I spoke with the teams and they are working on updates, but no
...
